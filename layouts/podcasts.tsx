...
export default function Podcasts({ children, frontMatter }: PodcastsProps) {
    return (
        <Container
            title={frontMatter?.title || "Podcasts – Rohit Jacob Mathew"}
            description={frontMatter?.summary || "Podcasts I actively listen to and find the most valuable."}
        >
            <div className="flex flex-col justify-center items-start max-w-3xl mx-auto w-full">
                ...
                <div className="prose prose-lg leading-relaxed text-gray-700 dark:text-gray-300 max-w-none">
                    <p className="text-lg mb-0 leading-relaxed text-justify">
                        Full compilation of podcasts I have found interesting. My recommendations can be found {" "}
                        <a href="links#podcasts" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors font-medium border-b border-blue-300 dark:border-blue-600 hover:border-blue-600 dark:hover:border-blue-300">
                            here
                        </a>.
                    </p>
                </div>
