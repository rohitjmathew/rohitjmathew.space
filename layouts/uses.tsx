...
export default function UsesLayout({ children, frontMatter }: UsesLayoutProps) {
  return (
    <Container
      ...
      description={frontMatter?.summary || "Tools, apps, and workflows that help me get things done, both professionally and personally. Tried-and-tested productivity setups."}
    >
      <div className="flex flex-col justify-center items-start max-w-3xl mx-auto w-full">
        ...
        <div className="prose prose-lg leading-relaxed text-gray-700 dark:text-gray-300 max-w-none">
          <p className="text-lg mb-0 leading-relaxed text-justify">
            The tools, apps, and workflows that help me get things done, both professionally and personally.
            From productivity setups to creative workflows, these are the tried-and-tested tools I rely on daily.
            Inspired by{" "}
            <a
              target="_blank"
              rel="noreferrer"
            ...
            , with a focus on tools that actually make a difference in how I work and live.
          </p>
        </div>
