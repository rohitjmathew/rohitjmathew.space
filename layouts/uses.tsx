...
export default function UsesLayout({ children, frontMatter }: UsesLayoutProps) {
  return (
    <Container
      title={frontMatter?.title || "Uses – Rohit Jacob Mathew"}
      description={frontMatter?.summary || "The tools, services, and techniques I'm using to get things done"}
    >
