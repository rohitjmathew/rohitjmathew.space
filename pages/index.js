    ...
    <Container>
      <div className="flex flex-col justify-center items-start max-w-2xl mx-auto mb-16">
        ...
        <h2 className="prose text-gray-600 dark:text-gray-400 mb-16">
          A Software Engineer from India working on building SecOps products at <a target="_blank" rel="noreferrer" href="https://www.mcafee.com/enterprise/en-us/home.html">McAfee Enterprise</a>.
